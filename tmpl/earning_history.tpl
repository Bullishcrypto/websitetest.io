...
<input type=hidden name=page value={$current_page}>
 <td>
   <select name=type class=inpts onchange="document.opts.submit();" style="width: 100%;">
...
<br><img src=images/q.gif width=1 height=4><br>
   <select name=ec class=inpts style="width: 100%;">
...
<tr>
 <th class=inheader><b>Type</b></td>
 <th class=inheader width=200><b>Amount</b></td>
 <th class=inheader width=170><b>Date</b></td>
</tr>
