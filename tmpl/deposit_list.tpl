...
<b class="deposit-total">Total: {$currency_sign}{$total}</b><br>
...
<tr>
 ...
 <th class=inheader>Plan</td>
 <th class=inheader width=200>Deposit Amount</td>
 <th class=inheader width=100 nowrap><nobr>{$p.period} Profit (%)</nobr></td>
</tr>
...
<tr>
 <th class=inheader>Date</td>
 <th class=inheader>Amount</td>
{if $p.use_compound}
...
<table cellspacing=0 cellpadding=1 border=0 class="tab">
