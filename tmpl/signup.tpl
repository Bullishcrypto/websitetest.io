...
<div class="box-onetype">
<div class="box-tittle">
<p>Your {$ps.name} Account :</p>
</div>
<div class="box-type">
    <input type=text class=inpts size=30 name=pay_account[{$ps.id}] value="{$ps.account|escape:html}" data-validate="{$ps.validate.func}" data-validate-{$ps.validate.func}="{$ps.validate[$ps.validate.func]}" data-validate-notice="{$ps.validate.notification|escape:html}" placeholder="{$ps.validate.placeholder|escape:html}">
</div>
</div>
{/foreach}
...
<div class="box-onetype">
<div class="box-tittle">
<p>Your {$p.name} {$ps.name} :</p>
</div>
<div class="box-type">
    <input type=text class=inpts size=30 name="pay_account[{$p.id}][{$ps.name|escape:html}]" value="{$ps.value|escape:html}">
</div>
</div>
{/foreach}
{/foreach}
...
<div class="agree">
<p>I accept <span><a target="_blank" href="{"?a=rules"|encurl}">Terms and conditions</a>
</span></p>
</div>
</div>
{if $ti.check.signup}
